...
import 'hr_results.dart';


//List<CameraDescription> cameras = [];

class hReader extends StatefulWidget {
  //final String title;
  @override
  State <hReader> createState() => _HreaderState();
}

class _HreaderState extends State<hReader> {
  ...
  Duration full_measure_time = Duration(seconds: 15); //TODO: change to 15
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(is_active ? "Active Heart Rate" : "Resting Heart Rate"),
